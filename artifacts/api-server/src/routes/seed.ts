...
const CHEMICALS = [
  ...
  { name: "NA", unit: "lbs", thresholdPercent: 30 },
  { name: "NA", unit: "lbs", thresholdPercent: 30 },
  { name: "Bulldog BWS 19", unit: "lbs", thresholdPercent: 30 },
  { name: "Low PH Citrus Foamy Lube BWS 101", unit: "lbs", thresholdPercent: 35 },
  { name: "Lava Wax Great BWS 100", unit: "lbs", thresholdPercent: 40 },
  { name: "Bug BWS 61", unit: "gallons", thresholdPercent: 30 },
  { name: "Best Red Polish BWS 54", unit: "gallons", thresholdPercent: 35 },
  { name: "NA", unit: "lbs", thresholdPercent: 25 },
  { name: "Presoak BWS 1000-33 CS", unit: "lbs", thresholdPercent: 25 },
  { name: "TVP for Wheels", unit: "gallons", thresholdPercent: 30 },
  { name: "NA", unit: "lbs", thresholdPercent: 30 },
  { name: "NA", unit: "lbs", thresholdPercent: 30 },
  { name: "Tub Soap BWS 36", unit: "lbs", thresholdPercent: 35 },
  { name: "Platinum Blue Polish BWS 1000-56", unit: "lbs", thresholdPercent: 40 },
  { name: "NA", unit: "gallons", thresholdPercent: 30 },
  { name: "NA", unit: "gallons", thresholdPercent: 25 },
  { name: "Ceramic Shield 102", unit: "lbs", thresholdPercent: 35 },
