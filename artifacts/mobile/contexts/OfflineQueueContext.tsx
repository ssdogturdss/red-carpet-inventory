...
interface OfflineQueueContextValue {
  ...
  addToQueue: (item: Omit<QueuedCount, "id" | "timestamp">) => Promise<void>;
  refresh: () => Promise<QueuedCount[]>;
}
...
export function OfflineQueueProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <OfflineQueueContext.Provider value={{ queue, isOnline, syncing, syncResult, syncQueue, addToQueue, refresh }}>
      {children}
